...
insert into bank_database.department (dept_name, dept_no, dept_phone_no, address_id) values ('Oddział Wokjskowy', 50, '483434387', 11);
insert into bank_database.department (dept_name, dept_no, dept_phone_no, address_id) values ('Drugi Oddział', 97, '128465153', 12);
...
insert into bank_database.account (acc_no, create_date, acc_balance, category_id) values ('47328467777772269322468095', sysdate(), 74475.14, 1);
insert into bank_database.account (acc_no, create_date, acc_balance, category_id) values ('22712300744442727293434511', sysdate(), 41692.88, 2);
insert into bank_database.account (acc_no, create_date, acc_balance, category_id) values ('65770684446666209324087017', sysdate(), 40422.74, 3);
insert into bank_database.account (acc_no, create_date, acc_balance, category_id) values ('11970172666662116862492316', sysdate(), 52996.66, 3);
insert into bank_database.account (acc_no, create_date, acc_balance, category_id) values ('08439675156448725212846682', sysdate(), 12546.66, 1);
 
insert into bank_database.customer_account (customer_id, account_id) values ( 1, 1);
insert into bank_database.customer_account (customer_id, account_id) values ( 2, 2);
insert into bank_database.customer_account (customer_id, account_id) values ( 1, 3);
insert into bank_database.customer_account (customer_id, account_id) values ( 3, 4);
