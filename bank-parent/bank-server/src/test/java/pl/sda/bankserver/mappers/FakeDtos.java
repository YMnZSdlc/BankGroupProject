...
public class FakeDtos {
    ...
    public static AccountDto createAccountDto() {
        ...
        dto.setService(serviceDtoList);
        dto.setCard(cardDtoList);
        dto.setAccountCategoryId(534);
        dto.setAccountHistoryIds(accountHistoryDtoList);
        dto.setCustomerIds(customerDtoList);
        return dto;
    }
    ...
    public static AddressDto createAddressDto() {
        ...
        dto.setDepartmentAddresses(workerDtoList);
        return dto;
    }
