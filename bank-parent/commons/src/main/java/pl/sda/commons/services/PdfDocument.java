...
public class PdfDocument implements ConvertToFile {
    ...
    public static boolean saveToPdf(Object data) {
    ...
    private static boolean addContent(Document document, Object data) throws DocumentException {
    ...
    private static void writeListOfObject(List list, java.util.List listOfObjects) throws IllegalAccessException {
